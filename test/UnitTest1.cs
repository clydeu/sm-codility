...
namespace test
{
    public class UnitTest1
    {
        ...
        public void Test1_test(int[] A, int result)
        {
            Task1.Function(A).Should().Be(result);
        }
        ...
        public void Test2_test(int[] A, int result)
        {
        ...
        public void Test3_test(int[] A, int result)
        {
